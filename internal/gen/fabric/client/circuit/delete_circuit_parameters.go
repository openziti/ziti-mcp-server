...
func (o *DeleteCircuitParams) WithOptions(options *models.CircuitDelete) *DeleteCircuitParams {
	o.SetOptions(options)
	return o
}

// SetOptions adds the options to the delete circuit params
func (o *DeleteCircuitParams) SetOptions(options *models.CircuitDelete) {
	o.Options = options
}

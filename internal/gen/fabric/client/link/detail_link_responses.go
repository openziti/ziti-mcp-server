...
type DetailLinkOK struct {
	Payload *models.DetailLinkEnvelope
}
...
func (o *DetailLinkUnauthorized) GetPayload() *models.APIErrorEnvelope {
	return o.Payload
}
...
func (o *DetailLinkNotFound) GetPayload() *models.APIErrorEnvelope {
	return o.Payload
}
...
func (o *DetailLinkTooManyRequests) GetPayload() *models.APIErrorEnvelope {
	return o.Payload
}

...
func (o *CreateDatabaseSnapshotReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 429:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[POST /database] createDatabaseSnapshot", response, response.Code())
	}
}
...
func (o *CreateDatabaseSnapshotOK) GetPayload() *models.Empty {
	return o.Payload
}
...
func (o *CreateDatabaseSnapshotUnauthorized) GetPayload() *models.APIErrorEnvelope {
	return o.Payload
}
...
func (o *CreateDatabaseSnapshotTooManyRequests) GetPayload() *models.APIErrorEnvelope {
	return o.Payload
}

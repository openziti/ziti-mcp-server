...
type UpdateTerminatorParams struct {
	...
	*/
	Terminator *models.TerminatorUpdate
...
func (o *UpdateTerminatorParams) WithTerminator(terminator *models.TerminatorUpdate) *UpdateTerminatorParams {
	o.SetTerminator(terminator)
	return o
}

// SetTerminator adds the terminator to the update terminator params
func (o *UpdateTerminatorParams) SetTerminator(terminator *models.TerminatorUpdate) {

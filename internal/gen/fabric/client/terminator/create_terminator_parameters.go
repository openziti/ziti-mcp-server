...
type CreateTerminatorParams struct {
	...
	*/
	Terminator *models.TerminatorCreate
...
func (o *CreateTerminatorParams) WithTerminator(terminator *models.TerminatorCreate) *CreateTerminatorParams {
	o.SetTerminator(terminator)
	return o
}

// SetTerminator adds the terminator to the create terminator params
func (o *CreateTerminatorParams) SetTerminator(terminator *models.TerminatorCreate) {

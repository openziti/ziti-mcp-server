...
func NewClusterTransferLeadershipParams() *ClusterTransferLeadershipParams {
	return &ClusterTransferLeadershipParams{
		timeout: cr.DefaultTimeout,
	}
}

// NewClusterTransferLeadershipParamsWithTimeout creates a new ClusterTransferLeadershipParams object
...
// NewClusterTransferLeadershipParamsWithContext creates a new ClusterTransferLeadershipParams object
...
// NewClusterTransferLeadershipParamsWithHTTPClient creates a new ClusterTransferLeadershipParams object
...
type ClusterTransferLeadershipParams struct {
	...
	*/
	Member *models.ClusterTransferLeadership
...
func (o *ClusterTransferLeadershipParams) WithDefaults() *ClusterTransferLeadershipParams {
	o.SetDefaults()
	return o
}
...
func (o *ClusterTransferLeadershipParams) WithTimeout(timeout time.Duration) *ClusterTransferLeadershipParams {
...
func (o *ClusterTransferLeadershipParams) WithContext(ctx context.Context) *ClusterTransferLeadershipParams {
	o.SetContext(ctx)
	return o
}
...
func (o *ClusterTransferLeadershipParams) WithHTTPClient(client *http.Client) *ClusterTransferLeadershipParams {
...
func (o *ClusterTransferLeadershipParams) WithMember(member *models.ClusterTransferLeadership) *ClusterTransferLeadershipParams {
	o.SetMember(member)
	return o
}

// SetMember adds the member to the cluster transfer leadership params
func (o *ClusterTransferLeadershipParams) SetMember(member *models.ClusterTransferLeadership) {
	o.Member = member
}

// WriteToRequest writes these params to a swagger request
func (o *ClusterTransferLeadershipParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {

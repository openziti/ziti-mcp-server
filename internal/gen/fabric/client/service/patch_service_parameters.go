...
func (o *PatchServiceParams) WithService(service *models.ServicePatch) *PatchServiceParams {
	o.SetService(service)
	return o
}

// SetService adds the service to the patch service params
func (o *PatchServiceParams) SetService(service *models.ServicePatch) {
	o.Service = service
}

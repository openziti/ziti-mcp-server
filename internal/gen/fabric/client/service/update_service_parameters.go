...
func (o *UpdateServiceParams) WithService(service *models.ServiceUpdate) *UpdateServiceParams {
	o.SetService(service)
	return o
}

// SetService adds the service to the update service params
func (o *UpdateServiceParams) SetService(service *models.ServiceUpdate) {
	o.Service = service
}

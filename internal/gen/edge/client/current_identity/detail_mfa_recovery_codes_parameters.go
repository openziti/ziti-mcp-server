...
func (o *DetailMfaRecoveryCodesParams) WithMfaValidation(mfaValidation *models.MfaCode) *DetailMfaRecoveryCodesParams {
	o.SetMfaValidation(mfaValidation)
	return o
}

// SetMfaValidation adds the mfaValidation to the detail mfa recovery codes params
func (o *DetailMfaRecoveryCodesParams) SetMfaValidation(mfaValidation *models.MfaCode) {

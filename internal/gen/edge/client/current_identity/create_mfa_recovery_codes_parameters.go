...
func (o *CreateMfaRecoveryCodesParams) WithMfaValidation(mfaValidation *models.MfaCode) *CreateMfaRecoveryCodesParams {
	o.SetMfaValidation(mfaValidation)
	return o
}

// SetMfaValidation adds the mfaValidation to the create mfa recovery codes params
func (o *CreateMfaRecoveryCodesParams) SetMfaValidation(mfaValidation *models.MfaCode) {

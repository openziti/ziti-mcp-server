...
func (o *DeleteMfaOK) GetPayload() *models.Empty {
	return o.Payload
}
...
func (o *DeleteMfaUnauthorized) GetPayload() *models.APIErrorEnvelope {
	return o.Payload
}
...
func (o *DeleteMfaNotFound) GetPayload() *models.APIErrorEnvelope {
	return o.Payload
}

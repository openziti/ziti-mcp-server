...
func (o *VerifyMfaParams) WithMfaValidation(mfaValidation *models.MfaCode) *VerifyMfaParams {
	o.SetMfaValidation(mfaValidation)
	return o
}

// SetMfaValidation adds the mfaValidation to the verify mfa params
func (o *VerifyMfaParams) SetMfaValidation(mfaValidation *models.MfaCode) {

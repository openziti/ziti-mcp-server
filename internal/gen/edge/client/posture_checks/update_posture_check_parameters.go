...
type UpdatePostureCheckParams struct {
	...
	*/
	PostureCheck models.PostureCheckUpdate
...
func (o *UpdatePostureCheckParams) WithPostureCheck(postureCheck models.PostureCheckUpdate) *UpdatePostureCheckParams {
	o.SetPostureCheck(postureCheck)
	return o
}

// SetPostureCheck adds the postureCheck to the update posture check params
func (o *UpdatePostureCheckParams) SetPostureCheck(postureCheck models.PostureCheckUpdate) {

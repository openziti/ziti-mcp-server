...
type CreatePostureCheckParams struct {
	...
	*/
	PostureCheck models.PostureCheckCreate
...
func (o *CreatePostureCheckParams) WithPostureCheck(postureCheck models.PostureCheckCreate) *CreatePostureCheckParams {
	o.SetPostureCheck(postureCheck)
	return o
}

// SetPostureCheck adds the postureCheck to the create posture check params
func (o *CreatePostureCheckParams) SetPostureCheck(postureCheck models.PostureCheckCreate) {

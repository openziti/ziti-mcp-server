...
type DetailPostureCheckTypeOK struct {
	Payload *models.DetailPostureCheckTypeEnvelope
}
...
func (o *DetailPostureCheckTypeOK) GetPayload() *models.DetailPostureCheckTypeEnvelope {
	return o.Payload
}
...
func (o *DetailPostureCheckTypeOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(models.DetailPostureCheckTypeEnvelope)
...
func (o *DetailPostureCheckTypeUnauthorized) GetPayload() *models.APIErrorEnvelope {
	return o.Payload
}
...
func (o *DetailPostureCheckTypeNotFound) GetPayload() *models.APIErrorEnvelope {
	return o.Payload
}
...
func (o *DetailPostureCheckTypeTooManyRequests) Error() string {
	return fmt.Sprintf("[GET /posture-check-types/{id}][%d] detailPostureCheckTypeTooManyRequests  %+v", 429, o.Payload)
}
...
func (o *DetailPostureCheckTypeTooManyRequests) GetPayload() *models.APIErrorEnvelope {
	return o.Payload
}
...
func (o *DetailPostureCheckTypeServiceUnavailable) Error() string {
	return fmt.Sprintf("[GET /posture-check-types/{id}][%d] detailPostureCheckTypeServiceUnavailable  %+v", 503, o.Payload)
}
...
func (o *DetailPostureCheckTypeServiceUnavailable) GetPayload() *models.APIErrorEnvelope {
	return o.Payload
}

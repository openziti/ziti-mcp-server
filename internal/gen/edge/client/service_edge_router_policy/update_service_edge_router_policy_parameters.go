...
type UpdateServiceEdgeRouterPolicyParams struct {
	...
	*/
	Policy *models.ServiceEdgeRouterPolicyUpdate
...
func (o *UpdateServiceEdgeRouterPolicyParams) WithPolicy(policy *models.ServiceEdgeRouterPolicyUpdate) *UpdateServiceEdgeRouterPolicyParams {
	o.SetPolicy(policy)
	return o
}

// SetPolicy adds the policy to the update service edge router policy params
func (o *UpdateServiceEdgeRouterPolicyParams) SetPolicy(policy *models.ServiceEdgeRouterPolicyUpdate) {
	o.Policy = policy
}

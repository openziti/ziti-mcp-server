...
type PatchServiceEdgeRouterPolicyParams struct {
	...
	*/
	Policy *models.ServiceEdgeRouterPolicyPatch
...
func (o *PatchServiceEdgeRouterPolicyParams) WithPolicy(policy *models.ServiceEdgeRouterPolicyPatch) *PatchServiceEdgeRouterPolicyParams {
	o.SetPolicy(policy)
	return o
}

// SetPolicy adds the policy to the patch service edge router policy params
func (o *PatchServiceEdgeRouterPolicyParams) SetPolicy(policy *models.ServiceEdgeRouterPolicyPatch) {
	o.Policy = policy
}

...
type UpdateAuthPolicyParams struct {
	...
	*/
	AuthPolicy *models.AuthPolicyUpdate
...
func (o *UpdateAuthPolicyParams) WithAuthPolicy(authPolicy *models.AuthPolicyUpdate) *UpdateAuthPolicyParams {
	o.SetAuthPolicy(authPolicy)
	return o
}

// SetAuthPolicy adds the authPolicy to the update auth policy params
func (o *UpdateAuthPolicyParams) SetAuthPolicy(authPolicy *models.AuthPolicyUpdate) {

...
type CreateAuthPolicyParams struct {
	...
	*/
	AuthPolicy *models.AuthPolicyCreate
...
func (o *CreateAuthPolicyParams) WithAuthPolicy(authPolicy *models.AuthPolicyCreate) *CreateAuthPolicyParams {
	o.SetAuthPolicy(authPolicy)
	return o
}

// SetAuthPolicy adds the authPolicy to the create auth policy params
func (o *CreateAuthPolicyParams) SetAuthPolicy(authPolicy *models.AuthPolicyCreate) {

...
func (o *UpdateTransitRouterParams) WithRouter(router *models.RouterUpdate) *UpdateTransitRouterParams {
	o.SetRouter(router)
	return o
}

// SetRouter adds the router to the update transit router params
func (o *UpdateTransitRouterParams) SetRouter(router *models.RouterUpdate) {
	o.Router = router
}

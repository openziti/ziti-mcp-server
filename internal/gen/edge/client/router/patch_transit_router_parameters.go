...
func (o *PatchTransitRouterParams) WithRouter(router *models.RouterPatch) *PatchTransitRouterParams {
	o.SetRouter(router)
	return o
}

// SetRouter adds the router to the patch transit router params
func (o *PatchTransitRouterParams) SetRouter(router *models.RouterPatch) {
	o.Router = router
}

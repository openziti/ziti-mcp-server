...
func (o *DeleteServiceNotFound) Error() string {
	return fmt.Sprintf("[DELETE /services/{id}][%d] deleteServiceNotFound  %+v", 404, o.Payload)
}
...
func (o *DeleteServiceNotFound) GetPayload() *models.APIErrorEnvelope {
	return o.Payload
}
...
func (o *DeleteServiceTooManyRequests) GetPayload() *models.APIErrorEnvelope {
	return o.Payload
}
...
func (o *DeleteServiceServiceUnavailable) GetPayload() *models.APIErrorEnvelope {
	return o.Payload
}

...
func (o *DetailServiceReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 429:
		...
		return nil, result
	case 503:
		result := NewDetailServiceServiceUnavailable()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
func (o *DetailServiceTooManyRequests) GetPayload() *models.APIErrorEnvelope {
	return o.Payload
}
...
func (o *DetailServiceServiceUnavailable) Error() string {
	return fmt.Sprintf("[GET /services/{id}][%d] detailServiceServiceUnavailable  %+v", 503, o.Payload)
}
...
func (o *DetailServiceServiceUnavailable) GetPayload() *models.APIErrorEnvelope {
	return o.Payload
}

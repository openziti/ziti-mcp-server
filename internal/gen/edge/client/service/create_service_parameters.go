...
func (o *CreateServiceParams) WithService(service *models.ServiceCreate) *CreateServiceParams {
	o.SetService(service)
	return o
}

// SetService adds the service to the create service params
func (o *CreateServiceParams) SetService(service *models.ServiceCreate) {
	o.Service = service
}

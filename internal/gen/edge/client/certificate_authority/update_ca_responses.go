...
func (o *UpdateCaTooManyRequests) GetPayload() *models.APIErrorEnvelope {
	return o.Payload
}
...
func (o *UpdateCaServiceUnavailable) Error() string {
	return fmt.Sprintf("[PUT /cas/{id}][%d] updateCaServiceUnavailable  %+v", 503, o.Payload)
}
...
func (o *UpdateCaServiceUnavailable) GetPayload() *models.APIErrorEnvelope {
	return o.Payload
}

...
import (
	...
	"github.com/openziti/ziti-mcp-server-go/internal/gen/edge/client/api_session"
	"github.com/openziti/ziti-mcp-server-go/internal/gen/edge/client/auth_policy"
	"github.com/openziti/ziti-mcp-server-go/internal/gen/edge/client/authentication"
	"github.com/openziti/ziti-mcp-server-go/internal/gen/edge/client/authenticator"
	"github.com/openziti/ziti-mcp-server-go/internal/gen/edge/client/certificate_authority"
	"github.com/openziti/ziti-mcp-server-go/internal/gen/edge/client/config"
	"github.com/openziti/ziti-mcp-server-go/internal/gen/edge/client/controllers"
	"github.com/openziti/ziti-mcp-server-go/internal/gen/edge/client/current_api_session"
	"github.com/openziti/ziti-mcp-server-go/internal/gen/edge/client/current_identity"
	"github.com/openziti/ziti-mcp-server-go/internal/gen/edge/client/database"
	"github.com/openziti/ziti-mcp-server-go/internal/gen/edge/client/edge_router"
	"github.com/openziti/ziti-mcp-server-go/internal/gen/edge/client/edge_router_policy"
	"github.com/openziti/ziti-mcp-server-go/internal/gen/edge/client/enrollment"
	"github.com/openziti/ziti-mcp-server-go/internal/gen/edge/client/external_j_w_t_signer"
	"github.com/openziti/ziti-mcp-server-go/internal/gen/edge/client/identity"
	"github.com/openziti/ziti-mcp-server-go/internal/gen/edge/client/informational"
	"github.com/openziti/ziti-mcp-server-go/internal/gen/edge/client/posture_checks"
	"github.com/openziti/ziti-mcp-server-go/internal/gen/edge/client/role_attributes"
	...
	"github.com/openziti/ziti-mcp-server-go/internal/gen/edge/client/service_edge_router_policy"
	"github.com/openziti/ziti-mcp-server-go/internal/gen/edge/client/service_policy"
	"github.com/openziti/ziti-mcp-server-go/internal/gen/edge/client/session"
	"github.com/openziti/ziti-mcp-server-go/internal/gen/edge/client/settings"
	"github.com/openziti/ziti-mcp-server-go/internal/gen/edge/client/terminator"
	"github.com/openziti/ziti-mcp-server-go/internal/gen/edge/client/well_known"
)

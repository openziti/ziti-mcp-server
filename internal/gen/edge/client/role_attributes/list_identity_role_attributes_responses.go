...
func (o *ListIdentityRoleAttributesOK) GetPayload() *models.ListRoleAttributesEnvelope {
	return o.Payload
}
...
func (o *ListIdentityRoleAttributesBadRequest) GetPayload() *models.APIErrorEnvelope {
	return o.Payload
}
...
func (o *ListIdentityRoleAttributesUnauthorized) GetPayload() *models.APIErrorEnvelope {
	return o.Payload
}
...
func (o *ListIdentityRoleAttributesTooManyRequests) GetPayload() *models.APIErrorEnvelope {
	return o.Payload
}
...
func (o *ListIdentityRoleAttributesServiceUnavailable) Error() string {
	return fmt.Sprintf("[GET /identity-role-attributes][%d] listIdentityRoleAttributesServiceUnavailable  %+v", 503, o.Payload)
}
...
func (o *ListIdentityRoleAttributesServiceUnavailable) GetPayload() *models.APIErrorEnvelope {
	return o.Payload
}

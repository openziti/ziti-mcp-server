...
func (o *PatchConfigParams) WithConfig(config *models.ConfigPatch) *PatchConfigParams {
	o.SetConfig(config)
	return o
}

// SetConfig adds the config to the patch config params
func (o *PatchConfigParams) SetConfig(config *models.ConfigPatch) {
	o.Config = config
}

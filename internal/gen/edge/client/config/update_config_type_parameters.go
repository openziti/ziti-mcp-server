...
type UpdateConfigTypeParams struct {
	...
	*/
	ConfigType *models.ConfigTypeUpdate
...
func (o *UpdateConfigTypeParams) WithConfigType(configType *models.ConfigTypeUpdate) *UpdateConfigTypeParams {
	o.SetConfigType(configType)
	return o
}

// SetConfigType adds the configType to the update config type params
func (o *UpdateConfigTypeParams) SetConfigType(configType *models.ConfigTypeUpdate) {

...
func (o *CreateConfigParams) WithConfig(config *models.ConfigCreate) *CreateConfigParams {
	o.SetConfig(config)
	return o
}

// SetConfig adds the config to the create config params
func (o *CreateConfigParams) SetConfig(config *models.ConfigCreate) {
	o.Config = config
}

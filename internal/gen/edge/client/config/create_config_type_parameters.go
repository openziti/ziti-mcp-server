...
type CreateConfigTypeParams struct {
	...
	*/
	ConfigType *models.ConfigTypeCreate
...
func (o *CreateConfigTypeParams) WithConfigType(configType *models.ConfigTypeCreate) *CreateConfigTypeParams {
	o.SetConfigType(configType)
	return o
}

// SetConfigType adds the configType to the create config type params
func (o *CreateConfigTypeParams) SetConfigType(configType *models.ConfigTypeCreate) {

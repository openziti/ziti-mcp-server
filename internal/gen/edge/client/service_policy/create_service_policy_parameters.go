...
type CreateServicePolicyParams struct {
	...
	*/
	Policy *models.ServicePolicyCreate
...
func (o *CreateServicePolicyParams) WithPolicy(policy *models.ServicePolicyCreate) *CreateServicePolicyParams {
	o.SetPolicy(policy)
	return o
}

// SetPolicy adds the policy to the create service policy params
func (o *CreateServicePolicyParams) SetPolicy(policy *models.ServicePolicyCreate) {
	o.Policy = policy
}

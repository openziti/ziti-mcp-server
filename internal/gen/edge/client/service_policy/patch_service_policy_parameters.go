...
type PatchServicePolicyParams struct {
	...
	*/
	Policy *models.ServicePolicyPatch
...
func (o *PatchServicePolicyParams) WithPolicy(policy *models.ServicePolicyPatch) *PatchServicePolicyParams {
	o.SetPolicy(policy)
	return o
}

// SetPolicy adds the policy to the patch service policy params
func (o *PatchServicePolicyParams) SetPolicy(policy *models.ServicePolicyPatch) {
	o.Policy = policy
}

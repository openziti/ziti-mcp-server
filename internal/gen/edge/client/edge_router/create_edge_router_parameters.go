...
type CreateEdgeRouterParams struct {
	...
	*/
	EdgeRouter *models.EdgeRouterCreate
...
func (o *CreateEdgeRouterParams) WithEdgeRouter(edgeRouter *models.EdgeRouterCreate) *CreateEdgeRouterParams {
	o.SetEdgeRouter(edgeRouter)
	return o
}

// SetEdgeRouter adds the edgeRouter to the create edge router params
func (o *CreateEdgeRouterParams) SetEdgeRouter(edgeRouter *models.EdgeRouterCreate) {

...
type PatchEdgeRouterParams struct {
	...
	*/
	EdgeRouter *models.EdgeRouterPatch
...
func (o *PatchEdgeRouterParams) WithEdgeRouter(edgeRouter *models.EdgeRouterPatch) *PatchEdgeRouterParams {
	o.SetEdgeRouter(edgeRouter)
	return o
}

// SetEdgeRouter adds the edgeRouter to the patch edge router params
func (o *PatchEdgeRouterParams) SetEdgeRouter(edgeRouter *models.EdgeRouterPatch) {

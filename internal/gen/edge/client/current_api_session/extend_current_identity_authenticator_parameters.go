...
type ExtendCurrentIdentityAuthenticatorParams struct {
	...
	// Extend.
	Extend *models.IdentityExtendEnrollmentRequest
...
func (o *ExtendCurrentIdentityAuthenticatorParams) WithExtend(extend *models.IdentityExtendEnrollmentRequest) *ExtendCurrentIdentityAuthenticatorParams {
	o.SetExtend(extend)
	return o
}

// SetExtend adds the extend to the extend current identity authenticator params
func (o *ExtendCurrentIdentityAuthenticatorParams) SetExtend(extend *models.IdentityExtendEnrollmentRequest) {
	o.Extend = extend
}

...
// NewCreateTotpTokenParamsWithTimeout creates a new CreateTotpTokenParams object
...
// NewCreateTotpTokenParamsWithContext creates a new CreateTotpTokenParams object
...
// NewCreateTotpTokenParamsWithHTTPClient creates a new CreateTotpTokenParams object
...
func (o *CreateTotpTokenParams) WithMfaValidation(mfaValidation *models.MfaCode) *CreateTotpTokenParams {
	o.SetMfaValidation(mfaValidation)
	return o
}

// SetMfaValidation adds the mfaValidation to the create totp token params
func (o *CreateTotpTokenParams) SetMfaValidation(mfaValidation *models.MfaCode) {

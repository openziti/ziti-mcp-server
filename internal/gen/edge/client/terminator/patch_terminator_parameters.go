...
type PatchTerminatorParams struct {
	...
	*/
	Terminator *models.TerminatorPatch
...
func (o *PatchTerminatorParams) WithTerminator(terminator *models.TerminatorPatch) *PatchTerminatorParams {
	o.SetTerminator(terminator)
	return o
}

// SetTerminator adds the terminator to the patch terminator params
func (o *PatchTerminatorParams) SetTerminator(terminator *models.TerminatorPatch) {

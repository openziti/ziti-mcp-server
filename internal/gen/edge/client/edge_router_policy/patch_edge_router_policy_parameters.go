...
type PatchEdgeRouterPolicyParams struct {
	...
	*/
	Policy *models.EdgeRouterPolicyPatch
...
func (o *PatchEdgeRouterPolicyParams) WithPolicy(policy *models.EdgeRouterPolicyPatch) *PatchEdgeRouterPolicyParams {
	o.SetPolicy(policy)
	return o
}

// SetPolicy adds the policy to the patch edge router policy params
func (o *PatchEdgeRouterPolicyParams) SetPolicy(policy *models.EdgeRouterPolicyPatch) {
	o.Policy = policy
}

...
type UpdateEdgeRouterPolicyParams struct {
	...
	*/
	Policy *models.EdgeRouterPolicyUpdate
...
func (o *UpdateEdgeRouterPolicyParams) WithPolicy(policy *models.EdgeRouterPolicyUpdate) *UpdateEdgeRouterPolicyParams {
	o.SetPolicy(policy)
	return o
}

// SetPolicy adds the policy to the update edge router policy params
func (o *UpdateEdgeRouterPolicyParams) SetPolicy(policy *models.EdgeRouterPolicyUpdate) {
	o.Policy = policy
}

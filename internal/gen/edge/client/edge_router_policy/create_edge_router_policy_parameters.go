...
type CreateEdgeRouterPolicyParams struct {
	...
	*/
	Policy *models.EdgeRouterPolicyCreate
...
func (o *CreateEdgeRouterPolicyParams) WithPolicy(policy *models.EdgeRouterPolicyCreate) *CreateEdgeRouterPolicyParams {
	o.SetPolicy(policy)
	return o
}

// SetPolicy adds the policy to the create edge router policy params
func (o *CreateEdgeRouterPolicyParams) SetPolicy(policy *models.EdgeRouterPolicyCreate) {
	o.Policy = policy
}

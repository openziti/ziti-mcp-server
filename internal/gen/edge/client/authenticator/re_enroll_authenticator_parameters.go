...
func (o *ReEnrollAuthenticatorParams) WithReEnroll(reEnroll *models.ReEnroll) *ReEnrollAuthenticatorParams {
	o.SetReEnroll(reEnroll)
	return o
}

// SetReEnroll adds the reEnroll to the re enroll authenticator params
func (o *ReEnrollAuthenticatorParams) SetReEnroll(reEnroll *models.ReEnroll) {
	o.ReEnroll = reEnroll
}

...
type CreateAuthenticatorParams struct {
	...
	*/
	Authenticator *models.AuthenticatorCreate
...
func (o *CreateAuthenticatorParams) WithAuthenticator(authenticator *models.AuthenticatorCreate) *CreateAuthenticatorParams {
	o.SetAuthenticator(authenticator)
	return o
}

// SetAuthenticator adds the authenticator to the create authenticator params
func (o *CreateAuthenticatorParams) SetAuthenticator(authenticator *models.AuthenticatorCreate) {

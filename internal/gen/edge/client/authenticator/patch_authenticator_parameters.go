...
type PatchAuthenticatorParams struct {
	...
	*/
	Authenticator *models.AuthenticatorPatch
...
func (o *PatchAuthenticatorParams) WithAuthenticator(authenticator *models.AuthenticatorPatch) *PatchAuthenticatorParams {
	o.SetAuthenticator(authenticator)
	return o
}

// SetAuthenticator adds the authenticator to the patch authenticator params
func (o *PatchAuthenticatorParams) SetAuthenticator(authenticator *models.AuthenticatorPatch) {

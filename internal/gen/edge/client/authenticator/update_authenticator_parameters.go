...
type UpdateAuthenticatorParams struct {
	...
	*/
	Authenticator *models.AuthenticatorUpdate
...
func (o *UpdateAuthenticatorParams) WithAuthenticator(authenticator *models.AuthenticatorUpdate) *UpdateAuthenticatorParams {
	o.SetAuthenticator(authenticator)
	return o
}

// SetAuthenticator adds the authenticator to the update authenticator params
func (o *UpdateAuthenticatorParams) SetAuthenticator(authenticator *models.AuthenticatorUpdate) {

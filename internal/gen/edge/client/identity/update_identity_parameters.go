...
type UpdateIdentityParams struct {
	...
	*/
	Identity *models.IdentityUpdate
...
func (o *UpdateIdentityParams) WithIdentity(identity *models.IdentityUpdate) *UpdateIdentityParams {
	o.SetIdentity(identity)
	return o
}

// SetIdentity adds the identity to the update identity params
func (o *UpdateIdentityParams) SetIdentity(identity *models.IdentityUpdate) {
	o.Identity = identity
}

...
func (o *UpdateIdentityTracingParams) WithTraceSpec(traceSpec *models.TraceSpec) *UpdateIdentityTracingParams {
	o.SetTraceSpec(traceSpec)
	return o
}

// SetTraceSpec adds the traceSpec to the update identity tracing params
func (o *UpdateIdentityTracingParams) SetTraceSpec(traceSpec *models.TraceSpec) {

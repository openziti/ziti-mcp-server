...
type CreateIdentityParams struct {
	...
	*/
	Identity *models.IdentityCreate
...
func (o *CreateIdentityParams) WithIdentity(identity *models.IdentityCreate) *CreateIdentityParams {
	o.SetIdentity(identity)
	return o
}

// SetIdentity adds the identity to the create identity params
func (o *CreateIdentityParams) SetIdentity(identity *models.IdentityCreate) {
	o.Identity = identity
}

...
func (o *PatchIdentityParams) WithIdentity(identity *models.IdentityPatch) *PatchIdentityParams {
	o.SetIdentity(identity)
	return o
}

// SetIdentity adds the identity to the patch identity params
func (o *PatchIdentityParams) SetIdentity(identity *models.IdentityPatch) {
	o.Identity = identity
}

...
LDFLAGS := -X github.com/openziti/ziti-mcp-server/internal/version.Version=$(VERSION) \
           -X github.com/openziti/ziti-mcp-server/internal/version.Commit=$(COMMIT) \
           -X github.com/openziti/ziti-mcp-server/internal/version.Date=$(DATE)
